var In=Object.defineProperty,On=Object.defineProperties;var Ln=Object.getOwnPropertyDescriptors;var sn=Object.getOwnPropertySymbols;var Mn=Object.prototype.hasOwnProperty,Cn=Object.prototype.propertyIsEnumerable;var J=(a,t,n)=>t in a?In(a,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):a[t]=n,W=(a,t)=>{for(var n in t||(t={}))Mn.call(t,n)&&J(a,n,t[n]);if(sn)for(var n of sn(t))Cn.call(t,n)&&J(a,n,t[n]);return a},cn=(a,t)=>On(a,Ln(t));var pn=(a,t,n)=>(J(a,typeof t!="symbol"?t+"":t,n),n);import{c as Zn,a as Rn,i as nn,d as D,u as hn,r as C,b as xn,o as wn,w as q,n as tn,e as w,f as E,g as Q,h as O,j as kn,p as on,k as rn,l as Z,m as En,q as Dn,s as yn,t as Nn,v as T,x as R,y as dn,z as un,A as v,B as d,F as $,C as P,D as Un,E as b,G as A,H,_ as Bn,I as Xn,J as vn,K,M as zn,L as An,N as Yn,O as Fn,P as an,Q as qn,R as mn,S as Tn,T as $n,U as Kn,V as Wn,W as Pn,X as Hn,Y as bn,Z as Vn,$ as Qn,a0 as Gn,a1 as Jn,a2 as nt,a3 as tt,a4 as at}from"./vendor.813164fd.js";const et=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerpolicy&&(i.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?i.credentials="include":e.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(e){if(e.ep)return;e.ep=!0;const i=n(e);fetch(e.href,i)}};et();const ot="modulepreload",gn={},it="/admin-vite-antdesign/",F=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${it}${o}`,o in gn)return;gn[o]=!0;const e=o.endsWith(".css"),i=e?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const r=document.createElement("link");if(r.rel=e?"stylesheet":ot,e||(r.as="script",r.crossOrigin=""),r.href=o,document.head.appendChild(r),e)return new Promise((s,g)=>{r.addEventListener("load",s),r.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},jn={name:"Home",meta:{title:"\u7F51\u5740",icon:"global-outlined",fixed:!0}},rt=[W({path:"/",component:()=>F(()=>import("./Home.a0f754ed.js"),["assets/Home.a0f754ed.js","assets/Home.4f4965a5.css","assets/vendor.813164fd.js"])},jn),{path:"/demo/list",name:"DemoList",component:()=>F(()=>import("./List.118d3948.js"),["assets/List.118d3948.js","assets/vendor.813164fd.js","assets/enums.ee0f71c1.js"])},{path:"/demo/form",name:"DemoForm",component:()=>F(()=>import("./FormDemo.a27f9a9f.js"),["assets/FormDemo.a27f9a9f.js","assets/vendor.813164fd.js","assets/enums.ee0f71c1.js"])},{path:"/children/:id?",name:"children",component:()=>F(()=>import("./children.0866ba7f.js"),["assets/children.0866ba7f.js","assets/vendor.813164fd.js"]),meta:{title:"children",parent:"DemoForm",icon:"chrome-outlined"}},{path:"/iframe",name:"Iframe",component:()=>F(()=>import("./Iframe.b5b210dc.js"),["assets/Iframe.b5b210dc.js","assets/vendor.813164fd.js"])}],lt=Zn({history:Rn("/admin-vite-antdesign"),routes:rt});var st={install(a){Object.keys(nn).forEach(t=>{a.component(t,nn[t])})}};var G=(a,t)=>{const n=a.__vccOpts||a;for(const[o,e]of t)n[o]=e;return n};const ct=a=>(on("data-v-073f2f42"),a=a(),rn(),a),pt=ct(()=>Z("span",{class:"custom-icon-seize"},"\u5360",-1)),dt=[pt],ut=D({props:{icon:null,color:null},setup(a){const t=a;hn(f=>({"2b1498e1":e.value}));const n=Object.keys(nn),o=C(null),e=C(""),i=C(!0),r=xn("theme");let s=null;wn(()=>{s&&s.disconnect(),s=null}),q([()=>t.icon,r],([f])=>{i.value=!n.includes((f||"").replace(/(-[A-Za-z])/g,u=>u[1].toUpperCase()).replace(/^[A-Za-z]/,u=>u.toUpperCase())),t.color?e.value=t.color:i.value&&tn(()=>{g()})},{immediate:!0});function g(){s&&s.disconnect();const f=o.value.parentElement;if(f){e.value=window.getComputedStyle(f).getPropertyValue("color");const u={attributes:!0},y=S=>{for(let x of S)x.type==="attributes"&&(e.value=window.getComputedStyle(f).getPropertyValue("color"))};s=new MutationObserver(y),s.observe(f,u)}}return(f,u)=>i.value?(w(),E("i",{key:0,ref_key:"customRef",ref:o,class:Q(["anticon custom-icon",t.icon])},dt,2)):(w(),O(kn(t.icon),{key:1}))}});var _n=G(ut,[["__scopeId","data-v-073f2f42"]]);const en=a=>typeof a=="object",fn=a=>en(a)?!Object.keys(a).length:!a&&a!==0;function V(a,t,n=[],o=!1){if(!en(a)||!en(t))return!o&&fn(a)&&fn(t)?!1:a!==t;const e=Object.keys(a).filter(r=>!n.length||n.includes(r)),i=Object.keys(t).filter(r=>!n.length||n.includes(r));return o&&e.length!==i.length?!0:e.some(r=>{const s=r;return V(a[s],t[s])})}function Wt(a){return a.reduce((t,{key:n,value:o})=>(t[n]=o)&&t||t,{})}const ln=En("tag",{state:()=>({data:JSON.parse(sessionStorage.getItem("tag")||"{}").data||[],tagFilterKeys:["name","query","params"]}),actions:{changeData(a){let t=!0;this.data.forEach(n=>{V(a,n,this.tagFilterKeys)?n.meta.active=!1:(n.meta.active=!0,t=!1)}),t&&(a.meta.active=!0,this.data.push(a))},removeData(a){let t=-1;for(let n=0;n<this.data.length;n++)if(!V(a,this.data[n],this.tagFilterKeys)){this.data.splice(n,1),t=n;break}return t}},persist:{enabled:!0,strategies:[{key:"tag",storage:sessionStorage,paths:["data"]}]}});function mt(a,t){const n=C(null),o=C(null),e=C([]),i=C(0),r=C(!1),s=8,g=300;Dn(()=>{y(),window.addEventListener("resize",u,!1)}),wn(()=>{window.removeEventListener("resize",u,!1)}),q(a,()=>y()),q(t,()=>{setTimeout(y,200)});function f(S){var c,m;const x=((c=n.value)==null?void 0:c.offsetWidth)||0,h=(((m=o.value)==null?void 0:m.offsetWidth)||0)-x;if(S==="left"){const k=i.value+160;i.value=Math.min(k,0)}else{const k=i.value-160;i.value=Math.max(k,-h)}}function u(){return y(!0)}function y(S=!1){tn(()=>{var c,m;const x=((c=n.value)==null?void 0:c.offsetWidth)||0;if((((m=o.value)==null?void 0:m.offsetWidth)||0)-x<0){r.value=!1,i.value=0;return}else r.value=!0;a.forEach((k,z)=>{var L;(L=k.meta)!=null&&L.active&&setTimeout(()=>{tn(()=>{var _,X;const j=((_=n.value)==null?void 0:_.offsetWidth)||0,M=((X=o.value)==null?void 0:X.offsetWidth)||0,l=M-j,I=Math.abs(i.value),N=j+I,{offsetLeft:U,offsetWidth:Y}=e.value[z].$el,B=U+Y;I>U&&(i.value=-U+s),N<B&&(i.value=j-B-s),j>M?i.value=Math.min(i.value,0):i.value=Math.max(i.value,-l)})},S?g:0)})})}return{translateX:i,showIcon:r,marginX:s,transitionTime:g,moveNavScroll:f,changePosition:y,navList:n,navScroll:o,navItem:e}}const bt={class:"nav"},gt=D({props:{collapsed:{type:Boolean}},setup(a){const t=a;hn(l=>({"4a963184":v(h),"318c3088":m,"3002b114":c}));const n=ln(),o=n.$state.data,e=yn(),i=Nn(),r=T(()=>t.collapsed),{translateX:s,showIcon:g,marginX:f,transitionTime:u,moveNavScroll:y,navList:S,navScroll:x,navItem:p}=mt(o,r),h=T(()=>`${s.value}px`),c=`${f}px`,m=`${u}ms`;function k(l){i.push(l)}function z(l){const I=n.removeData(l),{name:N,params:U,query:Y}=e;if(!V(l,{name:N,params:U,query:Y},n.tagFilterKeys)){const B=o[I]||o[I-1];B&&k(B)}}const L=C([]),j=l=>{L.value.includes(l)||L.value.push(l)},M=l=>{const I=L.value.indexOf(l);I>-1&&L.value.splice(I,1)};return(l,I)=>{const N=R("LeftOutlined"),U=_n,Y=Bn,B=R("RightOutlined");return w(),E("div",bt,[dn(d(N,{onClick:I[0]||(I[0]=_=>v(y)("left")),class:"nav-icon"},null,512),[[un,v(g)]]),Z("div",{ref_key:"navList",ref:S,class:"nav-list"},[Z("div",{ref_key:"navScroll",ref:x,class:"nav-scroll"},[(w(!0),E($,null,P(v(o),_=>(w(),O(Y,{ref_for:!0,ref_key:"navItem",ref:p,closable:!_.meta.fixed,class:Q(["nav-tag",_.meta.active||L.value.includes(_.id)?"nav-tag-active":null]),color:_.meta.active?"blue":"",key:_.id,onClick:X=>k(_),onClose:X=>z(_),onMouseover:X=>j(_.id),onMouseleave:X=>M(_.id)},Un({default:b(()=>[A(" "+H(_.meta.title),1)]),_:2},[_.meta.icon?{name:"icon",fn:b(()=>[d(U,{icon:_.meta.icon},null,8,["icon"])])}:void 0]),1032,["closable","class","color","onClick","onClose","onMouseover","onMouseleave"]))),128))],512)],512),dn(d(B,{onClick:I[1]||(I[1]=_=>v(y)("right")),class:"nav-icon"},null,512),[[un,v(g)]])])}}});var ft=G(gt,[["__scopeId","data-v-27bef2a0"]]);const ht=D({props:{data:null},setup(a){const t=a;return(n,o)=>{const e=_n,i=R("SubMenu",!0),r=Xn,s=R("router-link"),g=vn;return w(!0),E($,null,P(t.data,({title:f,children:u,name:y,icon:S,parent:x})=>(w(),E($,null,[u!=null&&u.length?(w(),O(r,{title:f,key:y},{icon:b(()=>[d(e,{icon:S},null,8,["icon"])]),default:b(()=>[d(i,{data:u},null,8,["data"])]),_:2},1032,["title"])):(w(),O(g,{key:y},{icon:b(()=>[d(e,{icon:S},null,8,["icon"])]),default:b(()=>[d(s,{to:y.match(/^https?:/)?{name:x==null?void 0:x.name,query:{iframe:y}}:{name:y}},{default:b(()=>[A(H(f),1)]),_:2},1032,["to"])]),_:2},1024))],64))),256)}}}),xt=D({props:{width:null,data:null,selectedKeys:null,openKeys:null,collapsed:{type:Boolean}},emits:["update:selectedKeys","update:openKeys"],setup(a,{emit:t}){const n=a,o=T({get(){return n.selectedKeys},set(i){t("update:selectedKeys",i)}}),e=T({get(){return n.openKeys},set(i){t("update:openKeys",i)}});return(i,r)=>{const s=ht,g=zn,f=An;return w(),O(f,{width:n.width,collapsed:a.collapsed},{default:b(()=>[d(g,{mode:"inline",selectedKeys:v(o),"onUpdate:selectedKeys":r[0]||(r[0]=u=>K(o)?o.value=u:null),openKeys:v(e),"onUpdate:openKeys":r[1]||(r[1]=u=>K(e)?e.value=u:null)},{default:b(()=>[d(s,{data:a.data},null,8,["data"])]),_:1},8,["selectedKeys","openKeys"])]),_:1},8,["width","collapsed"])}}}),wt=D({props:{type:null},setup(a){const t=a,n=Yn({scriptUrl:"//at.alicdn.com/t/font_1040735_q1mcxkcsfed.js"});return(o,e)=>(w(),O(v(n),{type:t.type},null,8,["type"]))}});const kt=a=>(on("data-v-4f1ad512"),a=a(),rn(),a),yt=kt(()=>Z("span",{class:"title-text"},"PawelLin",-1)),vt={class:"header-nav"},zt={key:1},jt={class:"header-right"},_t={class:"custom-link right-item",href:"javascript:;"},St=A(" pawel "),It=A(" \u4FEE\u6539\u5BC6\u7801 "),Ot=A(" \u9000\u51FA "),Lt={class:"right-item",href:"javascript:;"},Mt=["onClick"],Ct=["value"],Zt=D({props:{collapsed:{type:Boolean},setCollapsed:null,breadcrumbs:null},setup(a){const t=a,n=["#1890ff","#ff4d4f","#faad14","#52c41a"],o=Fn({primaryColor:n[0]});an.config({theme:o});const e=(r,s)=>{Object.assign(o,{[r]:s}),an.config({theme:o})},i=xn("theme");return(r,s)=>{const g=wt,f=R("MenuUnfoldOutlined"),u=R("MenuFoldOutlined"),y=R("router-link"),S=Tn,x=$n,p=R("user-outlined"),h=R("key-outlined"),c=vn,m=R("poweroff-outlined"),k=zn,z=Kn,L=Wn,j=R("skin-outlined"),M=Pn;return w(),O(M,{class:"header"},{default:b(()=>[Z("div",{class:Q(["title",t.collapsed?"title-collapsed":null])},[d(g,{type:"icon-brave",class:"title-icon"}),yt],2),Z("div",vt,[Z("div",{class:"collapsed",onClick:s[0]||(s[0]=(...l)=>t.setCollapsed&&t.setCollapsed(...l))},[t.collapsed?(w(),O(f,{key:0})):(w(),O(u,{key:1}))]),t.breadcrumbs.length>1?(w(),O(x,{key:0,class:"breadcrumb"},{default:b(()=>[(w(!0),E($,null,P(t.breadcrumbs,l=>(w(),O(S,{key:`${l.id||""}${l.name}`},{default:b(()=>[l.link?(w(),O(y,{key:0,to:l},{default:b(()=>[A(H(l.title),1)]),_:2},1032,["to"])):(w(),E("span",zt,H(l.title),1))]),_:2},1024))),128))]),_:1})):qn("",!0),Z("div",jt,[d(z,null,{overlay:b(()=>[d(k,null,{default:b(()=>[d(c,null,{default:b(()=>[d(h),It]),_:1}),d(c,null,{default:b(()=>[d(m),Ot]),_:1})]),_:1})]),default:b(()=>[Z("a",_t,[d(p),St])]),_:1}),d(L,{checked:v(i),"onUpdate:checked":s[1]||(s[1]=l=>K(i)?i.value=l:null),checkedValue:"theme-light",unCheckedValue:"theme-dark"},{checkedChildren:b(()=>[d(g,{type:"icon-taiyang"})]),unCheckedChildren:b(()=>[d(g,{type:"icon-yueliang"})]),_:1},8,["checked"]),d(z,null,{overlay:b(()=>[d(k,null,{default:b(()=>[(w(),E($,null,P(n,l=>Z("a",{class:"skin-item",href:"javascript:;",style:mn({backgroundColor:l}),key:l,onClick:I=>e("primaryColor",l)},null,12,Mt)),64)),Z("input",{class:"skin-item",type:"color",value:v(o).primaryColor,onInput:s[2]||(s[2]=l=>e("primaryColor",l.target.value))},null,40,Ct)]),_:1})]),default:b(()=>[Z("a",Lt,[d(j,{style:mn({color:v(o).primaryColor})},null,8,["style"])])]),_:1})])])]),_:1})}}});var Rt=G(Zt,[["__scopeId","data-v-4f1ad512"]]);class Et{constructor(t){pn(this,"instance");this.instance=Hn.create(t),this.instance.interceptors.request.use(function(n){return n.headers={token:""},n},function(n){return Promise.reject(n)}),this.instance.interceptors.response.use(function(n){return n.data.code&&n.data.code!=="0000"?(bn.error(n.data.message),Promise.reject(new Error(n.data.code))):n},function(n){const o=n.response.status===404?"\u51FA\u9519\u5566\uFF0C\u60A8\u8BBF\u95EE\u7684\u5730\u5740\u4E0D\u5B58\u5728":"\u51FA\u9519\u5566\uFF0C\u670D\u52A1\u7AEF\u9519\u8BEF";return bn.error(o),Promise.reject(n)})}get(t,n,o={}){return this.instance.get(t,W({params:n},o))}post(t,n,o={}){return this.instance.post(t,n,o)}}var Dt=new Et({baseURL:"https://www.fastmock.site/mock/69320153fd31dd2b99516a23375225d5/api"});function Nt(){const a=yn(),t=ln(),n=C([]),o=C([]),e=C([]),i=C([]),r=C(!1),s=()=>r.value=!r.value,g={},f={};q([()=>a.fullPath,()=>a.name,r],([x,p,h],[c,m])=>{if(p){const{params:k,query:z,meta:L}=a,j=Object.assign({title:"",active:!1},L);let M=j.parent;if(j.title=z.rename||j.title,!M){const l=g[z.iframe||p];l&&(j.title=l.title,j.icon=l.icon,j.parent=M=l.name)}if(o.value=M?[M]:[],h||(e.value=M?f[M]=f[M]||u(M):[]),!t.data.length){const{name:l,meta:I}=jn,N={name:l,id:`${l}-${Date.now()}`,meta:I};t.changeData(N)}if(x!==c||!m){const l={name:p,query:z,params:k,id:`${p}-${Date.now()}`,meta:j};t.changeData(l),i.value=y(p,l)}}});function u(x){var c;const p=[];let h=g[x];for(;(c=h.parent)!=null&&c.name;)p.unshift(h.parent.name),h=g[h.parent.name];return p}function y(x,p){var k,z,L,j;const h=[];let c=g[x];const m=(k=p==null?void 0:p.query)==null?void 0:k.iframe;if((!c||m)&&(h.unshift({id:p.id,name:p.name,title:p.meta.title,query:p.query,params:p.params}),c=g[m?p.name:p.meta.parent]),c)for(h.unshift({name:c.name,title:c.title,link:!((z=c.children)!=null&&z.length)});(L=c.parent)!=null&&L.name;)c=g[c.parent.name],h.unshift({name:c.name,title:c.title,link:!((j=c.children)!=null&&j.length)});return h}function S(x){const p=[],h={},c={};for(const m of x){const{parentId:k,id:z}=m;h[k]=h[k]||[],c[z]=Object.assign(c[z]||{},{name:m.name}),g[m.name]=m,k===0?p.push(m):h[k].push(m),h[z]=h[z]||[],m.parent=c[k]||(c[k]={name:""}),m.children=h[z]}return p}return Dt.get("/resource").then(x=>{const p=x.data.data;n.value=S((p==null?void 0:p.menus)||[])}).catch(()=>({})),{selectedKeys:o,openKeys:e,menus:n,breadcrumbs:i,collapsed:r,setCollapsed:s}}const Ut=a=>(on("data-v-1964511b"),a=a(),rn(),a),Bt={class:"content-view"},Xt=Ut(()=>Z("div",{id:"iframe"},null,-1)),At={name:"Layout"},Yt=D(cn(W({},At),{setup(a){const t=ln(),n=T(()=>t.data.filter(f=>!f.meta.noCache).map(f=>f.name)),{selectedKeys:o,openKeys:e,menus:i,breadcrumbs:r,collapsed:s,setCollapsed:g}=Nt();return(f,u)=>{const y=Rt,S=xt,x=ft,p=R("router-view"),h=Qn,c=Gn;return w(),O(c,null,{default:b(()=>[d(y,{class:"header",collapsed:v(s),setCollapsed:v(g),breadcrumbs:v(r)},null,8,["collapsed","setCollapsed","breadcrumbs"]),d(c,null,{default:b(()=>[d(S,{selectedKeys:v(o),"onUpdate:selectedKeys":u[0]||(u[0]=m=>K(o)?o.value=m:null),openKeys:v(e),"onUpdate:openKeys":u[1]||(u[1]=m=>K(e)?e.value=m:null),data:v(i),collapsed:v(s),class:"sider",width:"218px"},null,8,["selectedKeys","openKeys","data","collapsed"]),d(h,{class:"content"},{default:b(()=>[d(x,{class:"nav-tag-position",collapsed:v(s)},null,8,["collapsed"]),Z("div",Bt,[d(p,null,{default:b(({Component:m})=>[(w(),O(Vn,{include:v(n)},[(w(),O(kn(m)))],1032,["include"]))]),_:1}),Xt])]),_:1})]),_:1})]),_:1})}}}));var Ft=G(Yt,[["__scopeId","data-v-1964511b"]]),qt=`/*!
 * 
 * ant-design-vue v3.2.0
 *
...
/*# sourceMappingURL=antd.dark.css.map*/`;const Tt=D({setup(a){const t=C("theme-light");return Jn("theme",t),q(t,n=>{const o=document.getElementsByTagName("head")[0];let e=Array.from(o.getElementsByTagName("style")).filter(i=>i.getAttribute("data-type")==="theme")[0];n==="theme-light"&&e&&e.remove(),n==="theme-dark"&&!e&&(e=document.createElement("style"),e.dataset.type="theme",e.innerHTML=qt,o.appendChild(e))}),(n,o)=>{const e=Ft,i=an;return w(),O(i,null,{default:b(()=>[d(e,{class:Q(t.value)},null,8,["class"])]),_:1})}}});const Sn=nt();Sn.use(tt);at(Tt).use(Sn).use(lt).use(st).mount("#app");export{G as _,Wt as a,Dt as h,ln as u};
